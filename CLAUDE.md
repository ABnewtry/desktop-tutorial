...
## ab-film.html — البورتفوليو السينمائي v2 (فيلم تمرير كامل)
...
- الكائن يتنحى **يسار الشاشة دائماً** عبر متجه right من مصفوفة الكاميرا (وليس world-x): `net.position.copy(right).multiplyScalar(-2.25*aside)`.
- 13 صورة حقيقية data-URI في /tmp/folio_assets.json (أضفنا storyboard2 + case_site).
- **درس مهم:** كشف العناصر عبر IntersectionObserver + gsap.set/to وليس gsap.from+scrollTrigger (مع Lenis البطاقات تبقى opacity:0). الهيرو مستثنى لأن البريلودر يحرّكه.
