...
## ab-film.html — البورتفوليو السينمائي (فيلم تمرير كامل)
- صفحة مستقلة: https://abnewtry.github.io/desktop-tutorial/ab-film.html — **لا تعدّل index.html من أجلها**، هي نسخة سينمائية موازية بنفس معلومات البورتفوليو.
- عربي RTL بخط Cairo، 8 فصول: هيرو (عبد الرحمن — خبير بالذكاء الاصطناعي) → من أنا (صورته البرتقالية) → بوسترات ×3 → ستوري بورد → لاندنق بيجز ×3 → هويات ×3 (AB/قهوة/بطاطس) → ماذا تأخذ مني → CTA واتساب + روابط.
- الكائن البطل: حرفا AB معدن مصقول (نفس glyph متجر store-ab) بلون تمييز ليموني #C6F52E، مسار كاميرا 8 نقاط CatmullRom، والكائن "يتنحّى جانباً" (smoothstep على p بين 0.16→0.9) أثناء فصول الأعمال ليترك مساحة للصور.
- الصور الحقيقية مستخرجة من index.html (11 data-URI): هيرو، 3 بوسترات، ستوري بورد قهوة، 3 لاندنق، 3 هويات.
- **درس مهم:** كشف العناصر (.line/.fade/.pcard) عبر IntersectionObserver + gsap.set/to وليس gsap.from+scrollTrigger — الطريقة الثانية ما كانت تشتغل موثوقاً مع Lenis (البطاقات تبقى opacity:0). الهيرو (data-step=0) يُستثنى لأن البريلودر يحرّكه.
- المصدر: scratchpad/store/src/folio.js (بناء esbuild ثم حقن بايثون في dist/ab-film.html). exposure 0.84، bloom 0.32، معدن 0x83838c/env 0.6 — لا ترفعها وإلا انحرق الأبيض.
